...
async function get(battery, phn_info) {
    ...
    return ({
        msg: `*CK-Whatsbot* _(1.2.0)_\n\nThis chat is Powered By *CK-Whatsbot*\n\n*Battery:* ${batttxt}\n*Device:* ${phn_info.device_manufacturer} ${phn_info.device_model}\n*WA Version:* ${phn_info.wa_version}\n*Pmpermit:* ${config.pmpermit_enabled}\n*Mutetime:* ${config.pmpermit_mutetime/60} Minutes\n\n
        *Follow me on instagram 👇*\n` +
        "```https://instagram.com/arz_beats```",\n`  *Official Repository Url 👇*\n` + "```https://github.com/cyberkallanyt/wp-bot```",
      
        mimetype: "image/jpeg",
        data: Buffer.from(((await axios.get('https://telegra.ph/file/c36a22d9a926e5ec7e0eb.jpg', { responseType: 'arraybuffer' })).data)).toString('base64'),
        filename: "start.jpg"
    })
}
